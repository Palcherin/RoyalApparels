...
const Contact = () => {
  return (
    ...
    <div class="text-center px-6">
        ...
        <p class="text-sm text-gray-500 mt-4">Have some sportswear needs and you  need help?</p>
    </div>
    ...
    <div class="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
        ...
        <div class="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <p class="text-sm text-gray-300 mt-4">Have some sportswear needs and you  need help?</p>
            ...
            <ul class="mt-16 space-y-8">
                <li class="flex items-center">
                    ...
                    <a href="javascript:void(0)" class=" text-sm text-gray-500 ml-4">
                ...
                <li class="flex items-center">
                    ...
                    <a href="javascript:void(0)" class=" text-sm text-gray-500 ml-4">
                        Magic Business Center, along Ronald Ngala street, Wing B third floor BS15
                    </a>
                </li>
            </ul>
        ...
        <div class="p-4 lg:col-span-2">
            <form>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="flex max-lg:flex-col gap-6 mt-4">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-gray-500 ml-4">Get a Quatation</p>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-gray-500 ml-4">About our products</p>
                            </div>
                ...
                <button type="button"
                    class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide  bg-blue-600 hover:bg-blue-700">
