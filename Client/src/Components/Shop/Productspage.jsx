    ...
    <>
      {close && (
        <div className='bg-white w-fit h-fit'>
          {details.map((x) => (
            <div className='bg-white flex justify-start h-[105vh] w-[88vw] absolute z-1 ml-[5%] rounded mt-[10%] shadow-2xl' key={x.id}>
              ...
              <div className='basis-[40%] pt-[2%]'>
                ...
                <section className=''>
                  ...
                  <input placeholder='John Doe' type='number' className='w-[90%] ng-slate-50 p-2 outline-none border border-solid border-neutral-200 shadow-sm' />
                ...
                <section className='m-1'>
                  ...
                  <button className='bg-green-600 hover:bg-green-500 rounded p-2 w-[35%] m-1 font-bold' onClick={() => addToCart(x.id)}>ADD TO CART</button>
                </section>
              </div>
            </div>
          ))}
        ...
        {DATA.map((values) => {
          ...
          return (
            <div className='shadow-xl w-65 h-[410px] p-2 m-4' key={id}>
              <img src={Image} className='h-[50%] w-[80%] object-contain' />
              <section>
